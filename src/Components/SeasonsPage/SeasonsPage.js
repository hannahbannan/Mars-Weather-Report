...
const SeasonsPage = ({ weatherData }) => {
    ...
    <div className="season">
        ...
        <p>There isn't much "weather" on Mars. Apart from the varying sizes of the polar ice caps,dust storms that are common in late summer, and the changing temperature, there is little to indicate the passing of the seasons.</p>
    </div>
    )
}  else {
