...
const AboutPage = () => {
    return (<div className="About">
        ...
        <div className="text-container">
            <p className="one">NASA’s InSight Mars lander takes continuous weather measurements (temperate, wind, pressure) on the surface of Mars at <strong>Elysium Planitia</strong>, a flat, smooth plan near Mar’s equator. </p>
            <br />
            ...
            <div className="grid-container">
                <p className="temp"><strong>Termperatures</strong> on Mars are measured in degrees Celsius. Mars is generally considerably colder than Earth. However, temperatures on Mars fluctuate and sometimes it actually has mild, human-friendly weather. The highest temperature ever recorded on Mars was a balmy 86 degrees. </p>
                <p className="pressure"><strong>Atmospheric pressure</strong> is measured in Pascals using an air pressure sensor. Atmospheric pressure on Mars is less than on Earth - its atmosphere is “thinner” than Earth’s. For comparison, the average atmospheric pressure on Earth at sea level is around 101,325 Pascals. Mars’ atmospheric pressure averages about <strong>1%</strong> of the Earth’s pressure. </p>
                <p className="wind">The <strong>wind speed</strong> on Mars is on average calm, but Mars frequently experiences windstorms that sweep up the red dust all over its surface.</p>
                <br />
